    ...
    >
      <div className="max-w-6xl mx-auto px-4 sm:px-6 flex items-center justify-between">
        ...
        <Link href="/" className="flex items-center gap-3 group">
          <div className="w-8 h-8 rounded-lg bg-zinc-900 dark:bg-zinc-800 text-zinc-100 font-mono font-semibold text-xs flex items-center justify-center border border-zinc-700/80 group-hover:border-zinc-500 transition-colors">
            OS
          </div>
          <div>
