                  ...
                  <div className="space-y-6">
                    ...
                    <div className="px-6 space-y-5">
                      ...
                      <div className="p-4 sm:p-5 rounded-xl bg-blue-50/50 dark:bg-blue-950/20 border border-blue-200/60 dark:border-blue-900/40 space-y-4">
                        ...
                        {/* Vertical Timeline Steps (Continuous line from 1st bullet to last bullet) */}
                        <div className="relative pl-6 space-y-4">
                          {/* Continuous Line Track (Starts at top-2.5 of 1st bullet, stops at bottom-6 of last bullet) */}
                          <div className="absolute left-[6px] top-2.5 bottom-6 w-0.5 bg-blue-200 dark:bg-blue-800/80 pointer-events-none" />
