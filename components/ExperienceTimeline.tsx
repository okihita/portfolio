  ...
  return (
    <section id="experience" className="py-20 border-t border-zinc-200/80 dark:border-zinc-800/80 bg-zinc-50/50 dark:bg-[#09090b]">
      <div className="max-w-[1200px] mx-auto px-4 sm:px-6 space-y-12">
        ...
        {/* Vertical Timeline */}
        <div className="relative border-l border-zinc-300 dark:border-zinc-800 ml-3 sm:ml-6 space-y-12 pl-6 sm:pl-10">
          {PORTFOLIO_DATA.experience.map((item, idx) => (
            <div key={idx} className="relative group">
              {/* Timeline Dot */}
              <div className="absolute -left-[31px] sm:-left-[47px] top-1.5 w-3.5 h-3.5 rounded-full bg-white dark:bg-zinc-900 border-2 border-blue-500 group-hover:bg-blue-500 transition-colors" />

              <div className="craft-card rounded-xl p-6 space-y-4 border border-zinc-200/80 dark:border-zinc-800/80">
                {/* Role Header */}
                <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-2 border-b border-zinc-200/80 dark:border-zinc-800/80 pb-3">
                  <div>
                    <h3 className="text-lg font-bold text-zinc-900 dark:text-zinc-100">{item.role}</h3>
