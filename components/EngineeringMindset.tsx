...
export default function EngineeringMindset() {
  return (
    <section id="principles" className="py-20 border-t border-zinc-800/80 bg-[#09090b]">
      <div className="max-w-6xl mx-auto px-4 sm:px-6 space-y-12">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          {PORTFOLIO_DATA.principles.map((item, idx) => (
            <div
              key={idx}
              className="craft-card rounded-xl p-6 space-y-3 border border-zinc-800/80"
            >
              <div className="flex items-center gap-2">
                <span className="w-6 h-6 rounded bg-zinc-900 border border-zinc-700/80 flex items-center justify-center font-mono text-xs font-bold text-blue-400">
                  0{idx + 1}
                </span>
